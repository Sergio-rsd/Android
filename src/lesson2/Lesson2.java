...
public class Lesson2 {
    public static void main(String[] args) {
        ...
        System.out.println(comparisonInt(numberOne, numberTwo) ? "Сумма входит в интервал от 10 до 20 (включительно) - true" : "Сумма не входит в интервал от 10 до 20 (включительно) - false");
        ...
        System.out.println(leapYear(year) ? year + " - Это високосный год" : year + " - Это НЕ високосный год");
    }
